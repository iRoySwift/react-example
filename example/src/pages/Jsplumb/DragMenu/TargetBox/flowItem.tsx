...
const FlowItem: React.FC<Props> = (props) => {
  ...
  return (
    <div id={data.id} className={data.status ? 'viso-name viso-name-active' : 'viso-name'} style={{ left: `${data.x}px`, top: `${data.y}px` }} onClick={nodeMouseDown}>
      <div className="viso-name-body">
        ...
        <div className="viso-name-content">
          <div className="align-item-name">{data.data?.name}</div>
        </div>
